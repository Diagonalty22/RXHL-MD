...
if(usePairingCode && !rxhl.authState.creds.registered) {
		const phoneNumber = await question('mohon di masukin gan nomor bot lu supaya terhubung dengan Rxhl Bot di awali dengan Kode Negara:\n');
...
duingz = fs.readFileSync('./Assets/yuki.mp3'
sendMessage(from, duingz, audio, { quoted: mek, mimetype: 'audio/mp4', ptt:true }) 
